      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="no-print border border-stone-200 rounded-2xl p-4 shadow-sm space-y-3">
          <div className="flex flex-wrap items-end gap-3">
            ...
            <PrimaryBtn onClick={generate} disabled={!canGenerate} title={isWarehouse ? GENERATE_LOCKED_MSG : undefined}>
              <span className="material-symbols-outlined text-base">qr_code_2</span> Generate Units
            </PrimaryBtn>
          </div>

          {/* Inventory cap: never label more units than the lot holds. A warehouse
              can't generate at all, so it reads the count without the cap advice. */}
          {lot && (
            isWarehouse ? (
              <p className="text-[11px] text-stone-400">
                {units.length.toLocaleString('en-IN')} of {lotQty(lot).toLocaleString('en-IN')} unit(s) in this lot already labelled — {GENERATE_LOCKED_MSG}
              </p>
            ) : (
